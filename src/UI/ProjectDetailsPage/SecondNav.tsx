const SecondNav = () => {
  return (
    <div className="flex justify-center items-center font-bold [background:linear-gradient(rgb(229,247,163),rgb(160,164,56),rgb(136,144,53))] min-h-[45px] shadow-[0_4px_20px_0_#0000000f] backdrop-blur-[10px] text-white px-2 lg:hidden">
