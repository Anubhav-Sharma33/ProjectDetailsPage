...
const AmenitiesSection = () => {
  return (
    <div className="relative bg-fixed bg-center bg-cover flex flex-col items-center justify-center py-[2.5rem] bg-[url('https://sar.ecis.in/api/starestate/star_estate/project_gallery/2025-02-19T12-47-10_g3.jpg')] scroll-mt-[81px] md:scroll-mt-[86px]" id ="AmenitiesSection">
